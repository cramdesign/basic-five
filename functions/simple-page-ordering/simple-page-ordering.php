...
class Simple_Page_Ordering {
	...
	public function wp() {
		if ( 0 === strpos( get_query_var('orderby'), 'menu_order' ) ) {	// we can only sort if we're organized by menu order
			wp_enqueue_script( 'simple-page-ordering', get_template_directory_uri() . '/functions/simple-page-ordering/simple-page-ordering.js', array('jquery-ui-sortable'), '2.1', true );
			wp_enqueue_style( 'simple-page-ordering', get_template_directory_uri() . '/functions/simple-page-ordering/simple-page-ordering.css' );
		}
	}
